...
def prediction(request):
    try:
        ...
        model = load_model(r'C:\Users\naomi\OneDrive\Desktop\project\Automatic-Bug-Assigner\BugAssigner\prediction_api\dbbrna3.h5')
        predict = model.predict(X_test)
        sortedIndices = []
        pred_classes = []
        labels = pd.read_csv(r'C:\Users\naomi\OneDrive\Desktop\project\Automatic-Bug-Assigner\BugAssigner\prediction_api\labels.csv')
